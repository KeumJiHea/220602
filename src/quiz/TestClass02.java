...
public class TestClass02 {
   ...
   public void editMenu() {
      while(true) {
         ...
         if(bvg.menumap.containsKey(modimenu)) { //메뉴가 있을때
            System.out.println("선택하신 제품은 "+modimenu+"|"+bvg.menumap.get(modimenu)+"원 입니다.");
            ...
            if(modichoice ==1) { // 가격수정
               ...
               System.out.print("현재가격"+bvg.menumap.get(modimenu)+"원 "+">>>> ");
	      ...
	      if(bvg.menumap.isEmpty()) {
	         ...
	         int i=1;
	          while(it.hasNext()) {
	            ...
	            System.out.println(i+". "+inmenu+"\t"+bvg.menumap.get(inmenu)+"원");
	            i++;
	          }
		     System.out.println("======================");
